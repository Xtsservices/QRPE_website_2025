...
const InsightCard3D = ({ insight, index }: { insight: InsightCard; index: number }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          className="relative bg-[#0d3054]/60 backdrop-blur-sm rounded-xl overflow-hidden hover:bg-[#0d3054]/80 hover:shadow-2xl hover:shadow-[#0270ca]/40 transition-all duration-300 border border-[#0270ca]/20 hover:border-[#0270ca]/70"
          style={{ transform: 'translateZ(0)' }}
        >
          {/* Image */}
          <div 
            className="relative h-56 overflow-hidden bg-gradient-to-br from-[#0d3054] to-[#0270ca]"
            style={{ transform: 'translateZ(20px)' }}
          >
            <ImageWithFallback
              src={insight.image}
            ...
            >
              ...
              >
                <Badge
                  ...
                  className="bg-[#0270ca] backdrop-blur-sm text-white border-0"
                >
                  {insight.type}
                </Badge>
              </motion.div>
...
const InsightsSection3D = () => {
  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-br from-[#0d3054] via-[#0d3054] to-[#0270ca] relative overflow-hidden" style={{ perspective: '1000px' }}>
      ...
      <motion.div
        className="absolute top-1/4 right-1/4 w-64 h-64 bg-[#0270ca]/30 rounded-full blur-3xl"
        style={{ y }}
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {insights.map((insight, index) => (
            <InsightCard3D key={insight.link} insight={insight} index={index} />
          ))}
        </div>
      </div>
    </section>
...
export default InsightsSection3D;
